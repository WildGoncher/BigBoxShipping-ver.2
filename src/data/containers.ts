...
export const containers: Container[] = [
  ...
  },
  {
    ...
    imageUrl: "/images/containers/40-high-cube.jpg",
    description:
      "Контейнер с <strong>увеличенной шириной</strong> с объемом 70 м³ и максимальной грузоподъемностью 27 тонн.",
    features: [
      "Длина: 12.03 м",
      "Ширина: 2.44 м",
      "Высота: 2.69 м",
  ...
  },
  {
    ...
    imageUrl: "/images/containers/20-refrigerated.jpg",
    description:
